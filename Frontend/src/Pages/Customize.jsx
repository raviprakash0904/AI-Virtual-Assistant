...
function Customize() {
  ...
  return (
    ...
    <Card image={image6}/>
    <Card image={image7}/>
        <div className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#030326] border-2 border-[#0000ff41] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex items-center justify-center  ${selectedImage=="input"? "border-4 border-white shadow-2xl shadow-blue-950":null}`} onClick={()=>{
    ...
    {selectedImage && <button className='min-w-[150px] h-[60px] bg-white rounded-full text-black font-semibold mt-10 text-[19px] cursor-pointer' onClick={()=>navigate("/customize2")}>Next</button> }
