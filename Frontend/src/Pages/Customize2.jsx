...
function Customize2() {
    ...
    const handleUpdateAssistant=async ()=>{
        try {
            ...
            // Agar user ne predefined image select ki hai
            if (selectedImage) {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#010158] flex justify-center items-center flex-col p-[20px]'>
      ...
      {assistantName && <button className='min-w-[300px] h-[60px] bg-white rounded-full text-black font-semibold mt-10 text-[19px] cursor-pointer' onClick={()=>{
